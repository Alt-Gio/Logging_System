    ...
    <section className="py-16 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto px-4">
        ...
        <div className="relative">
          ...
          <div className="overflow-x-auto pb-4" style={{ scrollbarWidth: 'none' }}>
            <div className="flex gap-6 w-max px-8">
              ...
              <div className="rounded-2xl overflow-hidden border border-white/10 shadow-2xl bg-white flex-shrink-0" style={{ width: 380 }}>
                <div id="fb-root" />
                <div
                  className="fb-page"
              ...
              <div className="flex flex-col gap-4 flex-shrink-0 w-72 justify-center">
                <div className="bg-white/5 border border-white/10 rounded-2xl p-6 backdrop-blur-sm">
                  ...
                  <p className="text-blue-200/60 text-sm leading-relaxed">
                    Follow DICT Region V Bicol on Facebook for the latest news, events, and digital services updates.
                  </p>
        ...
        <div className="text-center mt-8">
          <a href="https://www.facebook.com/DICTRegionVBicol" target="_blank" rel="noopener noreferrer"
            className="inline-flex items-center gap-3 bg-blue-600 hover:bg-blue-500 text-white font-bold px-8 py-3 rounded-full transition-all shadow-lg shadow-blue-600/30 hover:scale-105">
