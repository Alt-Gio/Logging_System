...
const INFO_CARDS = [
  {
    ...
    desc: 'High-speed internet access available for all walk-in clients at the Digital Transformation Center.',
  ...
  },
  {
    ...
    desc: 'Get assistance with government online transactions, forms, and digital document services.',
  ...
  },
  {
    ...
    desc: 'Free workshops and training sessions on digital skills for all ages and skill levels.',
  ...
  },
  {
    icon: '🏛️',
    title: 'eGov Services',
    desc: 'Access SSS, PhilHealth, Pag-IBIG, and other government online portals with staff assistance.',
  ...
  },
  {
    ...
    desc: 'Learn how to stay safe online. Free seminars on cybersecurity and data privacy.',
  ...
  },
  {
    ...
    desc: 'DICT Region V bridges the digital divide, bringing ICT services to underserved communities.',
      ...
      <div className="max-w-7xl mx-auto px-4 relative z-10">
        ...
        <div className="text-center mb-16">
          ...
          <p className="text-blue-300/60 text-lg max-w-2xl mx-auto">
            Stay connected with the latest news, events, and digital services 
            from the Digital Transformation Center.
          </p>
        </div>

        {/* Main layout — FB feed left, cards right */}
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-8 items-start">

          {/* Facebook Feed — sticky on desktop */}
          <div className="lg:sticky lg:top-8">
            ...
            {/* Follow button */}
              ...
              className="mt-4 w-full flex items-center justify-center gap-3 bg-blue-600 hover:bg-blue-500 text-white font-bold py-3.5 rounded-2xl transition-all duration-300 hover:shadow-lg hover:shadow-blue-600/30 hover:scale-[1.02] active:scale-[0.98]"
            >
          ...
          <div className="flex flex-col gap-4">
            {INFO_CARDS.map((card, i) => (
              <div
                key={i}
                className={`
                  group relative bg-gradient-to-br ${card.color} 
                  border ${card.border} rounded-2xl p-6 
            ...
            <div className="grid grid-cols-3 gap-3 mt-2">
              {[
                ...
                <div key={i}
                  className="bg-white/5 border border-white/10 rounded-xl p-4 text-center hover:bg-white/10 hover:-translate-y-1 hover:shadow-lg transition-all duration-300 cursor-default">
